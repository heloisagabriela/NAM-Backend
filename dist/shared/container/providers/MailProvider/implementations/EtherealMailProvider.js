...
var _IMailTemplateProvider = _interopRequireDefault(require("../../MailTemplateProvider/model/IMailTemplateProvider"));
...
let EtherealMailProvider = (_dec = (0, _tsyringe.injectable)(), _dec2 = function (target, key) {
  ...
  async sendMail({
    ...
    const message = await this.client.sendMail({
      from: {
        name: (from === null || from === void 0 ? void 0 : from.name) || 'Acervo de música mineira',
        address: (from === null || from === void 0 ? void 0 : from.email) || 'equipe@sistemaNam.com.br'
      },
      to: {
        name: to.name,
        address: to.email
